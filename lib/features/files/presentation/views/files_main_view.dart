          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        OutlinedButton.icon(
                          onPressed: () async {
                            final folderName = await CreateFolderModal.show(
                              context,
                            );
                            if (folderName != null) {
              ...
              Container(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    _InteractiveFilterDropdown(
                      label: filterState.sortOrder == null
                          ? 'Sort'
                          : 'Sort: ${filterState.sortOrder}',
                      options: const [
                        'date_desc',
                    ...
                    if (filterState.fileType != null ||
                        filterState.sortOrder != null)
                      TextButton(
                        onPressed: () => ref
                            .read(filesFilterProvider.notifier)
                            .clearFilters(),
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: colors.borderOutline.withValues(
                                alpha: 0.5,
                              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border(
                    bottom: BorderSide(color: colors.borderOutline),
                  ),
                ),
                child: Row(
                  children: [
