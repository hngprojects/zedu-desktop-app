      ...
      child: Column(
        children: [
          _SidebarItem(
            ...
            onTap: () =>
                ref.read(filesFilterProvider.notifier).updateCategory('all'),
          ),
          _SidebarItem(
          ...
          _SidebarItem(
            ...
            onTap: () =>
                ref.read(filesFilterProvider.notifier).updateCategory('shared'),
          ),
          _SidebarItem(
